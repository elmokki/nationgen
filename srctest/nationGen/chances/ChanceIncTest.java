...
public class ChanceIncTest {
  ...
  public void testConditionAnd() {
    Assert.assertFalse(
      ChanceInc.parse("false and false *2").condition.test(new ChanceIncData())
    );
    Assert.assertFalse(
      ChanceInc.parse("false and true *2").condition.test(new ChanceIncData())
    );
    Assert.assertFalse(
      ChanceInc.parse("true and false *2").condition.test(new ChanceIncData())
    );
    Assert.assertTrue(
      ChanceInc.parse("true and true *2").condition.test(new ChanceIncData())
    );
  }
  ...
  public void testConditionOr() {
    Assert.assertFalse(
      ChanceInc.parse("false or false *2").condition.test(new ChanceIncData())
    );
    Assert.assertTrue(
      ChanceInc.parse("false or true *2").condition.test(new ChanceIncData())
    );
    Assert.assertTrue(
      ChanceInc.parse("true or false *2").condition.test(new ChanceIncData())
    );
    Assert.assertTrue(
      ChanceInc.parse("true or true *2").condition.test(new ChanceIncData())
    );
  }
  ...
  public void testParentheses() {
    Assert.assertTrue(
      ChanceInc.parse("false and false or true *2").condition.test(
        new ChanceIncData()
      )
    );
    Assert.assertFalse(
  ...
  public void testDoubleParentheses() {
    Assert.assertTrue(
      ChanceInc.parse("false and false and false or true *2").condition.test(
        new ChanceIncData()
      )
    );
    Assert.assertFalse(
      ChanceInc.parse(
        "false and (false and (false or true)) *2"
      ).condition.test(new ChanceIncData())
    );
  }
