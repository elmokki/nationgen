...
public class RestrictionPane
  ...
  public void actionPerformed(ActionEvent arg0) {
    // Add button
    if (
      arg0.getSource().equals(addButton) && possibles.getSelectedIndex() > -1
    ) {
      NationRestriction newres = NationRestrictionFactory.getSameTypedInstance(
        assets,
        possibles.getSelectedValue()
      );
