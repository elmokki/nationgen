...
public class Name {
  ...
  public String toString(Unit u) {
    ...
    prefixprefixprefix.toString(u) +
    " ";
    if (prefixprefix != null) str = str + prefixprefix.toString(u) + " ";
    if (prefix != null) str = str + prefix.toString(u) + " ";
    if (type != null) str = str + type.toString(u) + " ";

    if (suffixprefix != null || suffix != null) str = str + "of ";

    if (definitesuffix && (suffix != null || suffixprefix != null)) str = str +
    "the ";

    if (suffixprefix != null) str = str + suffixprefix.toString(u) + " ";
    if (suffix != null && !pluralsuffix) str = str + suffix.toString(u) + " ";
    else if (suffix != null) str = str +
    Generic.plural(suffix.toString(u)) +
    " ";
  ...
  public String getPrefixSuffix() {
    String str = "";
    if (rankprefix != null) str = str + rankprefix + " ";

    if (prefixprefixprefix != null) str = str + prefixprefixprefix + " ";

    if (prefixprefix != null) str = str + prefixprefix + " ";

    if (prefix != null) str = str + prefix + " ";

    if (suffixprefix != null) str = str + suffixprefix + " ";
  ...
  public boolean isDuplicate(Name other) {
    ...
    for (int i = 0; i < otherList.size(); i++) {
      ...
      if (thisPart != null) {
        if (
          otherPart == null
        ) areSame = false; // Both need to be null if one is
        else if (
          !otherPart.equals(thisPart)
        ) areSame = false; // Different text
      } else if (
        otherPart != null
      ) areSame = false; // Both need to be null if one is
    }
